...
// 		fmt.Println("dps[0].TimestampNanos", dps[0].TimestampNanos)
// 		fmt.Println("rollupPeriodNanos", rollupPeriodNanos)
// 		fmt.Println("drollupTimestamp", rollupTimestamp)
...
// 	res = trimTimeseriesDatapointSlice(res, targetResolution, qts)
...
// 	}
// 	if rollup.datapoints[0].timestampNanos != qts.StartNanos {
// 		fmt.Println("Something shifted")
// 	}
// 	fmt.Println(rollup)
// 	return res, nil
// }
...
// 	expectedLen := (qts.EndNanos - qts.StartNanos) / resolution.SampleDuration()
// 	fmt.Println("expectedLen", expectedLen)
