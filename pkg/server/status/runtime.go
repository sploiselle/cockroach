...
var (
	metaCgoCalls       = metric.Metadata{
		Name: "sys.cgocalls", Help: "Total number of cgo calls", Units: metric.UnitsCount, AxisLabel: "cgo Calls"
	}
	metaGoroutines     = metric.Metadata{
		Name: "sys.goroutines", Help: "Current number of goroutines", Units: metric.UnitsCount, AxisLabel: "goroutines"
	}
	metaGoAllocBytes   = metric.Metadata{
		Name: "sys.go.allocbytes", Help: "Current bytes of memory allocated by go", Units: metric.UnitsBytes, AxisLabel: "Size"
	}
	metaGoTotalBytes   = metric.Metadata{
		Name: "sys.go.totalbytes", Help: "Total bytes of memory allocated by go, but not released", Units: metric.UnitsBytes, AxisLabel: "Size"
	}
	metaCgoAllocBytes  = metric.Metadata{
		Name: "sys.cgo.allocbytes", Help: "Current bytes of memory allocated by cgo", Units: metric.UnitsBytes, AxisLabel: "Size"
	}
	metaCgoTotalBytes  = metric.Metadata{
		Name: "sys.cgo.totalbytes", Help: "Total bytes of memory allocated by cgo, but not released", Units: metric.UnitsBytes, AxisLabel: "Size"
	}
	metaGCCount        = metric.Metadata{
		Name: "sys.gc.count", Help: "Total number of GC runs", Units: metric.UnitsCount, AxisLabel: "GC Runs"
	}
	metaGCPauseNS      = metric.Metadata{
		Name: "sys.gc.pause.ns", Help: "Total GC pause in nanoseconds", Units: metric.UnitsDuration, AxisLabel: "Time"
	}
	metaGCPausePercent = metric.Metadata{
		Name: "sys.gc.pause.percent", Help: "Current GC pause percentage", Units: metric.UnitsCount, AxisLabel: "Percent"
	}
	metaCPUUserNS      = metric.Metadata{
		Name: "sys.cpu.user.ns", Help: "Total user cpu time in nanoseconds", Units: metric.UnitsDuration, AxisLabel: "Time"
	}
	metaCPUUserPercent = metric.Metadata{
		Name: "sys.cpu.user.percent", Help: "Current user cpu percentage", Units: metric.UnitsCount, AxisLabel: "Percent"
	}
	metaCPUSysNS       = metric.Metadata{
		Name: "sys.cpu.sys.ns", Help: "Total system cpu time in nanoseconds", Units: metric.UnitsDuration, AxisLabel: "Time"
	}
	metaCPUSysPercent  = metric.Metadata{
		Name: "sys.cpu.sys.percent", Help: "Current system cpu percentage", Units: metric.UnitsCount, AxisLabel: "Percent"
	}
	metaRSS            = metric.Metadata{
		Name: "sys.rss", Help: "Current process RSS", Units: metric.UnitsBytes, AxisLabel: "RSS"
	}
	metaFDOpen         = metric.Metadata{
		Name: "sys.fd.open", Help: "Process open file descriptors", Units: metric.UnitsCount, AxisLabel: "File Descriptors"
	}
	metaFDSoftLimit    = metric.Metadata{
		Name: "sys.fd.softlimit", Help: "Process open FD soft limit", Units: metric.UnitsCount, AxisLabel: "File Descriptors"
	}
	metaUptime         = metric.Metadata{
		Name: "sys.uptime", Help: "Process uptime in seconds", Units: metric.UnitsDuration, AxisLabel: "Time"
	}
)
...
func MakeRuntimeStatSampler(clock *hlc.Clock) RuntimeStatSampler {
	...
	metaBuildTimestamp := metric.Metadata{
		Name: "build.timestamp", Units: metric.UnitsDuration, AxisLabel: "Time", Help: "Build information"
	}
