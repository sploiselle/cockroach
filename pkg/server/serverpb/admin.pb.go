...
import cockroach_server_catalog "github.com/cockroachdb/cockroach/pkg/server/catalog"
...
// ChartCatalogRequest requests a catalog of available charts metadata for metrics.
...
func (*ChartCatalogRequest) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{45} }

// ChartCatalogRequest requests a catalog of available charts metadata for metrics.
type ChartCatalogResponse struct {
	DownsampAndAggKey map[int32]string                        `protobuf:"bytes,1,rep,name=downsampAndAggKey" json:"downsampAndAggKey" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	DerKey            map[int32]string                        `protobuf:"bytes,2,rep,name=derKey" json:"derKey" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	UnitsKey          map[int32]string                        `protobuf:"bytes,3,rep,name=unitsKey" json:"unitsKey" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	MetricTypeKey     map[int32]string                        `protobuf:"bytes,4,rep,name=metricTypeKey" json:"metricTypeKey" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Catalog           []cockroach_server_catalog.ChartSection `protobuf:"bytes,5,rep,name=catalog" json:"catalog"`
}
...
func (*ChartCatalogResponse) Descriptor() ([]byte, []int) { return fileDescriptorAdmin, []int{46} }
...
func (m *ChartCatalogResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.DownsampAndAggKey) > 0 {
		keysForDownsampAndAggKey := make([]int32, 0, len(m.DownsampAndAggKey))
		for k := range m.DownsampAndAggKey {
			keysForDownsampAndAggKey = append(keysForDownsampAndAggKey, int32(k))
		}
		sortkeys.Int32s(keysForDownsampAndAggKey)
		for _, k := range keysForDownsampAndAggKey {
			dAtA[i] = 0xa
			i++
			v := m.DownsampAndAggKey[int32(k)]
	...
	if len(m.DerKey) > 0 {
		keysForDerKey := make([]int32, 0, len(m.DerKey))
		for k := range m.DerKey {
			keysForDerKey = append(keysForDerKey, int32(k))
		}
		sortkeys.Int32s(keysForDerKey)
		for _, k := range keysForDerKey {
			dAtA[i] = 0x12
			i++
			v := m.DerKey[int32(k)]
			mapSize := 1 + sovAdmin(uint64(k)) + 1 + len(v) + sovAdmin(uint64(len(v)))
	...
	if len(m.UnitsKey) > 0 {
		keysForUnitsKey := make([]int32, 0, len(m.UnitsKey))
		for k := range m.UnitsKey {
			keysForUnitsKey = append(keysForUnitsKey, int32(k))
		}
		sortkeys.Int32s(keysForUnitsKey)
		for _, k := range keysForUnitsKey {
			dAtA[i] = 0x1a
			i++
			v := m.UnitsKey[int32(k)]
			mapSize := 1 + sovAdmin(uint64(k)) + 1 + len(v) + sovAdmin(uint64(len(v)))
			i = encodeVarintAdmin(dAtA, i, uint64(mapSize))
			dAtA[i] = 0x8
			i++
...
func (m *ChartCatalogResponse) Size() (n int) {
	...
	_ = l
	if len(m.DownsampAndAggKey) > 0 {
		for k, v := range m.DownsampAndAggKey {
			_ = k
			_ = v
...
func (m *ChartCatalogResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DownsampAndAggKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DownsampAndAggKey == nil {
				m.DownsampAndAggKey = make(map[int32]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.DownsampAndAggKey[mapkey] = mapvalue
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DerKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.DerKey == nil {
				m.DerKey = make(map[int32]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.DerKey[mapkey] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field UnitsKey", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.UnitsKey == nil {
				m.UnitsKey = make(map[int32]string)
			}
			var mapkey int32
			var mapvalue string
			for iNdEx < postIndex {
		...
		case 5:
			...
			m.Catalog = append(m.Catalog, cockroach_server_catalog.ChartSection{})
...
var fileDescriptorAdmin = []byte{
	...
	,
}
